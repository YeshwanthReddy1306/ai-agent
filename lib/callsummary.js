...
const EMPTY = { interest: 'unknown', summary: 'Call too short to assess.', nextAction: 'Follow-up call', objections: [], unansweredQuestions: [], appointment: { booked: false, when: null }, extracted: { studentName: '', courseInterest: '', visitInterest: 'unknown', scholarshipInterest: 'unknown' } };
