...
| **FreJun Teler (India, real published rates 2026-07-07)** | Unlimited plans EXCLUDE API/automated calls → use **Teler**: outbound ₹0.15/min + **media streaming ₹0.15/min** (likely ₹0.30/min all-in per connected AI minute) · inbound ₹0.10+₹0.15 · channel ₹600/mo, **10-ch min** (₹6k floor) · BYO Sarvam (no AI-compute charge) · testing credits. ⚠ ONE open Q: does media streaming stack every minute? ([Teler pricing](https://www.frejun.ai/pricing-page/)) | LEAD option, confirmed Indian-priced |
